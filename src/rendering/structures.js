export function drawHamletStructure(ctx, { pixelX, pixelY, size }) {
  ctx.save();
...
export const customStructureDrawers = {
  HAMLET: drawHamletStructure,
  ROADSIDE_TAVERN: drawRoadsideTavernStructure,
  DARK_DWARFHOLD: drawDarkDwarfholdStructure,
  AMBIENT_HUNTING_LODGE: drawAmbientHuntingLodgeStructure,
  AMBIENT_MOONWELL: drawAmbientMoonwellStructure
};
